...
class  Skill_Adapter_Template3(private val  context: Context, private val skill:List<Skills>) :
    RecyclerView.Adapter<Skill_Adapter_Template3.Skill_ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Skill_ViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.itemskill3,parent,false)
    ...
    class Skill_ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        var skillpercentage:IconRoundCornerProgressBar = itemView.findViewById(R.id.nep) as IconRoundCornerProgressBar
